    ...
    constructor(props) {
      ...
      this.columns = [
          ...
          }, 
          {
            ...
            sorter: (a,b) => this.compStringReverse(a.Teacher, b.Teacher),
          },
          {
            title: '앱 번호',
            dataIndex: 'App',
          ...
          <Layout style={{ minHeight: '100vh' }}>
            ...
            >
              ...
              <Menu theme="dark" defaultSelectedKeys={['7']} mode="inline" style={{maxHeight:"898px"}}>
                ...
                <SubMenu
                  key="sub2"
                  title={<span><Icon type="user" /><span>학생별 사용이력</span></span>}
                >
            ...
            <Layout>
              <Header style={{ background: '#1DA57A', padding: 0 }} >
                <Breadcrumb style={{ margin: '12px 0'}}>
                  <Breadcrumb.Item><h1 style={{color : 'white' , marginLeft : "3vh", fontWeight :"bolder", fontSize : "3.2vh"}}>학생별 사용이력</h1></Breadcrumb.Item>
                </Breadcrumb>
              </Header>
